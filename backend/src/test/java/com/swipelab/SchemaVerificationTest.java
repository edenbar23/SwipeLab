...
// ResultSet tables = metaData.getTables(null, "PUBLIC", null, new String[] {
// "TABLE" });
...
// assertTrue(tableNames.contains("classifications"), "Table 'classifications'
// should exist");

// // Verify Gamification Tables
// assertTrue(tableNames.contains("badges"), "Table 'badges' should exist");
// assertTrue(tableNames.contains("user_badges"), "Table 'user_badges' should
// exist");
// assertTrue(tableNames.contains("leaderboards"), "Table 'leaderboards' should
// exist");

// // Verify Gold Image Tables
// assertTrue(tableNames.contains("gold_images"), "Table 'gold_images' should
// exist");
