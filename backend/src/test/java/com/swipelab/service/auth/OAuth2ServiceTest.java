...
// // Assert
// assertEquals("Old Name", result.getDisplayName()); // Code only updates if
// null
// assertEquals("old_pic.url", result.getProfileImageUrl()); // Code only
// updates if null
...
// when(oAuth2User.getAttribute("email")).thenReturn(email);
// when(oAuth2User.getAttribute("name")).thenReturn("Name"); // Stub required
// calls
// when(oAuth2User.getAttribute("picture")).thenReturn("pic"); // Stub required
// calls
// when(oAuth2User.getAttribute("sub")).thenReturn(sub);
...
// // Assert
// assertEquals("google_123", result.getProviderId()); // Should link provider
// ID
